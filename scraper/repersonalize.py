...
# Loop through each personalization and corresponding scraped data
for personalization, text in zip(personalizations, scraped_data):
    prompt = f"""
...
"""
    ...
    repersonalizations.append(new_personalization)

# Save the new personalizations to a JSON file
with open('repersonalization_mcb.json', 'w') as outfile:
    json.dump(repersonalizations, outfile, indent=4)
