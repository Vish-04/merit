...
with open('emails_genetics.json', 'r') as f:
    emails = json.load(f)

with open('names_genetics.json', 'r') as f:
    name = json.load(f)

with open('repersonalization_genetics_2.json', 'r') as f:
    personalization = json.load(f)

# Email configuration
sender_email = "ntbuntzen@ucdavis.edu"
subject = "An Inquiry Regarding Your Research"
major = 'Genetics'

# SMTP server configuration
smtp_server = 'smtp.gmail.com'
smtp_port = 587  
smtp_user = "ntbuntzen@ucdavis.edu" 
smtp_password = "vsvu csnr wjsx qwpn"
...
My name is David, and I'm a undergraduate student in the College of Biological Sciences at UC Davis. 
